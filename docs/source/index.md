...
We will use [jupyter lab](https://jupyterlab.readthedocs.io/en/latest/) throughout the workshop. If you are unfamiliar with jupyter lab, please come to our ["Intro to Jupyter Lab"](jupyter) session in the Omni San Diego Hotel, Gallery 1, at 4:30pm on Wednesday, November 12.
